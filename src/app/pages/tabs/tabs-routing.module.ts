...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'schedule/schedule-roster',
        loadChildren: () => import('../schedule-roster/schedule-roster.module').then( m => m.ScheduleRosterPageModule)
      },
      {
        path: 'directory',
      ...
      {
        path: 'directory/dir-list/view-person/view-person-schedule',
        loadChildren: () => import('../view-person-schedule/view-person-schedule.module').then( m => m.ViewPersonSchedulePageModule)
      }
    ]
  }
];
